...
//           <div key={index} className={index === 0 ? "patient-box1" : "patient-box2"}>
//             <div className={index === 0 ? "patient-image1" : "patient-image2"}>
...
//           <div
//             key={index}
//             className={`progress-dot ${index === currentTestimonial ? 'active' : ''}`}
//           />
//         ))}
//       </div>
//     </section>
...
const Patients = () => {
  ...
  // Get two testimonials for the current view
